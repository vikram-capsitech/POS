...
export const DEFAULT_PERMISSIONS = [
  ...
  { key: "advance:manage", module: "advance", label: "Approve / Reject Advance" },
  ...
  { key: "document:manage", module: "document", label: "Upload / Edit Documents" },
  ...
  const defaults = [
    {
      ...
      permissions: get([
        ...
        "advance:read", "advance:manage",
        "payroll:read",
        "reports:read",
        "voucher:read", "voucher:manage",
